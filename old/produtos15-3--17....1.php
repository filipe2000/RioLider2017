...
<div class="container">
		...
		<br><br>
	<div  class="row subR">	
		<div class="prod-filter  col-lg-1 col-md-2 col-sm-2 col-xs-2">
			...
			<li>
				<a href="#produtos" onclick="carregar('includes/produtos/correia/correia.html')" class="filter">Correia</a>
			</li>
			<li>
			...
			<li>
				<a href="#produtos" onclick="carregar('includes/produtos/flange/flange.html')" class="filter">Flange</a>
			</li>
			<li>
				<a href="#produtos" onclick="carregar('includes/produtos/oleos/oleo.html')" class="filter">Óleo</a>
			</li>
			<li>
				<a href="#produtos" onclick="carregar('includes/produtos/palheta/palheta.html')" class="filter">Palheta</a>
			</li>			
			 -->
			<a href="#catalogo">
			<i class="fa fa-newspaper-o homeProd"  id="rote" title="Catálogo dos produtos"></i>
			</a>
			</ul>
		</div>

		<div class="col-lg-10 col-md-9 col-sm-10 col-xs-10" id="divProd" align="center"  >
